...
void orxIDE_init() {
  ...
  if (!ImGui::Begin("orxIDE", &ShowOrxIDE, ImGuiWindowFlags_AlwaysAutoResize))
  ...
  ImGui::Text("orxVersion %s", __orxVERSION_FULL_STRING__);
